...
var TodoItem$ReactTemplate = require("../components/todos/TodoItem.bs.js");
var TodoFooter$ReactTemplate = require("../components/todos/TodoFooter.bs.js");
  ...
  return /* record */[
          ...
          /* render */(function (param) {
              ...
              var todoItems = Belt_List.map(__x, (function (todo) {
                      ...
                      return ReasonReact.element(todo[/* id */0], undefined, TodoItem$ReactTemplate.make(todo, editing$1, (function (_event) {
              ...
              if (exit === 1) {
                footer = ReasonReact.element(undefined, undefined, TodoFooter$ReactTemplate.make(activeTodoCount, completedCount, state[/* nowShowing */0], (function (_event) {
...
exports.urlToShownPage = urlToShownPage;
